...
const reviews_data = [
  {
    ...
    comment: "Niagara Casino is a must-have for any gaming enthusiast. The experience is top-notch.",
  },
  {
    img: "./media/photos/comments/comment2.png",
    name: "William Taylor",
    comment:
      "Niagara Casino exceeds expectations! The games are diverse and the bonuses are plentiful. A solid 5 out of 5!",
  },
  {
    img: "./media/photos/comments/comment3.png",
    name: "Chloe Thompson",
    comment:
      "Niagara Casino is my absolute favorite! The visuals are stunning, and the gameplay is seamless. A perfect 5 out of 5",
  },
  {
    img: "./media/photos/comments/comment4.png",
    name: "Ethan Martinez",
    comment: "Niagara Casino never fails to impress! The range of games keeps me engaged every time.",
  },
  {
    img: "./media/photos/comments/comment5.png",
    name: "Olivia Wilson",
    comment: "I rely on Niagara Casino for my gaming fix! The interface is intuitive and the games are thrilling",
  },
];
