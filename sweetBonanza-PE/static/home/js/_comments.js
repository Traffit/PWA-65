...
const reviews_data = [
  {
    ...
    name: "José Flores",
    comment: "¡Sweet Bonanza es increíble! Gané 500 soles en una noche. ¡Lo recomiendo a todos! 5 de 5",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Carlos Rojas",
    comment:
      "No puedo dejar de jugar a estas tragamonedas. He ganado varias veces, la última vez gané 300 soles. 4.5 de 5",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "María Sánchez",
    comment:
      "Sweet Bonanza es una verdadera delicia. Gané 350 soles en las tragamonedas. ¡Los gráficos y la jugabilidad son excelentes! 5 de 5",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Miguel Gómez",
    comment: "Este casino realmente sabe cómo ofrecer emociones. Gané 450 soles y sigo jugando. ¡Lo recomiendo! 5 de 5",
  },

  {
    ...
    name: "Ana López",
    comment:
      "Estoy muy contenta con este casino. Gané 400 soles y pienso seguir jugando. ¡Lo recomiendo a todos! 4.5 de 5",
  },
];
