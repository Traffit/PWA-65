...
const reviews_data = [
  {
    ...
    name: "Андрій Коваль",
    comment: "Sweet Bonanza – це просто неймовірно! Граю вже кілька днів і не можу відірватися. 5/5!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Ірина Коваленко",
    comment: "чудовий спосіб розважитися та виграти гроші одночасно. Завжди захоплююче грати!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Віталій Петров",
    comment: "це моє улюблене казино. Величезний вибір ігор та щедрі бонуси. 5/5!",
  },
];
