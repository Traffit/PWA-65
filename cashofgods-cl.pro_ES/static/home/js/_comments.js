...
const reviews_data = [
  {
    ...
    name: "Liam Smith",
    comment:
      "¿Qué podría ser mejor que disfrutar de dulces y ganar a lo grande? ¡Olympus es mi elección para las victorias más dulces!",
  },
  {
    img: "../../media/photos/comments/comment2.png",
    name: "Olivia Tremblay",
    comment:
      "¡He estado jugando a Olympus durante semanas y simplemente me cautiva! ¡Victorias consistentes y montones de giros gratis! ¡Adoro absolutamente esta tragaperras!",
  },
  {
    img: "../../media/photos/comments/comment3.png",
    name: "Noah MacKenzie",
    comment:
      "¡Este juego es una explosión de emoción! ¡Los colores vibrantes y la acción sin parar de Olympus lo hacen una delicia adictiva!",
  },
  {
    img: "../../media/photos/comments/comment4.png",
    name: "Emma Gagnon",
    comment:
      "¡Olympus es un festín para los ojos y el bolsillo! Me encanta la emoción constante de las victorias en cascada y la abundancia de giros gratis.",
  },
  {
    img: "../../media/photos/comments/comment5.png",
    name: "Lucas Leblanc",
    comment:
      "¡No puedo tener suficiente de esta tragaperras con temática dulce! Olympus es mi placer culpable con sus gráficos fantásticos y su gran potencial de victorias.",
  },
  {
    img: "../../media/photos/comments/comment6.png",
    name: "Ava Dubois",
    comment:
      "¡Este juego es como una tienda de dulces de ganancias! ¡Los giros gratis de Olympus nunca dejan de traer esas deliciosas victorias!",
  },
  {
    img: "../../media/photos/comments/comment7.png",
    name: "Ethan Roy",
    comment:
      "¡Totalmente adicto a Olympus! La emoción de las victorias consecutivas con la función de caída es inigualable.",
  },
  {
    img: "../../media/photos/comments/comment8.png",
    name: "Charlotte Lefebvre",
    comment:
      "Olympus satisface mi deseo tanto de dulces como de victorias. Es una combinación fantástica de diversión y potenciales grandes premios.",
  },
  {
    img: "../../media/photos/comments/comment9.png",
    name: "Benjamin Beaulieu",
    comment:
      "¡Es un juego tan divertido! Los giros gratis de Olympus me hacen volver por más, y los visuales son simplemente encantadores.",
  },
  {
    img: "../../media/photos/comments/comment10.png",
    name: "Sophia Caron",
    comment:
      "¡Olympus nunca decepciona! ¡Amo la descarga de adrenalina cuando esas victorias en cascada siguen llegando! ¡Altamente recomendado!",
  },
];
